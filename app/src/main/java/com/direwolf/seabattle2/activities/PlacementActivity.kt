    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        continueButton.setOnClickListener {
            ...
            if (flag) {
                ...
                val advancedDifficulty = this.intent.extras?.getBoolean("advancedDifficulty", false) ?: false
                intent.putExtra("advancedDifficulty", advancedDifficulty)
